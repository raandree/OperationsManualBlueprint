...
glossary (including hybrid and cloud terms), the contact directory, and the
external references the practices are based on.
...
| Hybrid identity | An identity that exists in Active Directory and is synchronized to the Entra tenant. |
| Conditional Access | The Entra policy engine that decides whether to grant a sign-in and under what conditions. |
| Shared responsibility | The division of operational duties between the team and the cloud provider. |
...
| _Identity lead_ | _—_ | _—_ | _—_ |
| _Messaging lead_ | _—_ | _—_ | _—_ |
| _Endpoint lead_ | _—_ | _—_ | _—_ |
| _Cloud lead_ | _—_ | _—_ | _—_ |
| _Security lead_ | _—_ | _—_ | _—_ |
| _Microsoft support_ | _—_ | _Support plan / portal_ | _—_ |
